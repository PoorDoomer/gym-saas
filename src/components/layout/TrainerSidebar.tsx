...
export function TrainerSidebar() {
  ...
  // Trainer-specific navigation - only what trainers need
  const navigation = [
    { name: 'Dashboard', href: '/trainer-dashboard', icon: LayoutDashboard },
    { name: 'My Classes', href: '/trainer/schedule', icon: Calendar },
    { name: 'Class Members', href: '/trainer/class-members', icon: Users },
    { name: 'Check-ins', href: '/trainer/checkins', icon: UserCheck },
    { name: 'My Performance', href: '/trainer/performance', icon: Trophy },
      ...
      <div className="flex items-center h-16 px-6 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-slate-500 dark:text-slate-400">Trainer Portal</span>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-2">
            <Button 
              ...
              onClick={() => router.push('/trainer/checkins')}
            >
